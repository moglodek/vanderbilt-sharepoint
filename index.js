const INTERCEPT_XML = true

const URL = 'https://vanderbilt365.sharepoint.com/sites/FinanceChatbot/_api/web/'

const SP_USERNAME = '...provide username here...'
const SP_PASSWORD = '...provide password here...'



if (INTERCEPT_XML) {
    const { OnlineUserCredentials } = require('node-sp-auth/lib/src/auth/resolvers/OnlineUserCredentials')

    const originalPostToken = OnlineUserCredentials.prototype.postToken
    OnlineUserCredentials.prototype.postToken = function (xml){
        var me = this;
        console.log("\n\nIntercepted XML:");
        console.log(formatXml(xml));
        console.log("\n\n")
        return originalPostToken.call(me, xml);
    }
}
...
console.log('URL:', URL, 'USERNAME:', SP_USERNAME, 'PASSWORD:', SP_PASSWORD);
